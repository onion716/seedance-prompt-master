...
function buildUserPrompt(payload) {
  ...
  return [
    ...
    `参考图片：${String(payload.referenceImages || "").trim() || "无"}`,
    `参考视频：${String(payload.referenceVideos || "").trim() || "无"}`,
    `参考音频：${String(payload.referenceAudios || "").trim() || "无"}`,
